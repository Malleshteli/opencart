...
public class ExtentReportManager implements ITestListener {
	...
	try {
        ...
        URL url = new URL("file:///" + report.getAbsolutePath().replace("\\", "/"));
        ...
        email.setAuthenticator(new DefaultAuthenticator(
                "malleshateli11@gmail.com",
                "Mallesha@11"));

        email.setSSLOnConnect(true);

        email.setFrom("malleshateli11@gmail.com");
        email.addTo("malleshateli@gmail.com");

        email.setSubject("Automation Test Report");
        email.setHtmlMsg("<h3>Please find the attached Extent Report.</h3>");
        email.setTextMsg("Please find the attached Extent Report.");

        email.attach(url, "ExtentReport.html", "Automation Test Report");
